            ...
            case(state)
                ...
                ST_IDLE : begin
                    ...
                    if(cmd_valid) begin
                        ...
                        state               <= ST_START;
                        ack_err             <= 1'b0;        //co loi chi reset khi co tin hieu moi
                    end
                end
                ...
                ST_START : begin
                    ...
                    case(phase)
                        ...
                        2'b11 : begin
                            ...
                            if(phase_tick) state    <= ST_WR_DEV_ADD;        
                        end
                    endcase
                end
                ...
                ST_ACK_DEV_ADD : begin
                    case(phase)
                        ...
                        2'b11 : begin
                            ...
                            bit_cnt                 <= 3'd7;
                            if(phase_tick) state    <= ST_WR_REG_ADD;
                        end
                    endcase
                end
                ...
                ST_REP_START : begin
                    case(phase) 
                        ...
                        2'b10 : begin scl_drive_low <= 1'b0; sda_drive_low <= 1'b1; end
                        2'b11 : begin
                            scl_drive_low           <= 1'b1;
                            bit_cnt                 <= 3'd7;
                            tx_shift_data           <= {saved_addr, 1'b1}; //bit 1 la de thong bao read
                            if(phase_tick) state    <= ST_WR_DEV_ADD_R;
                        end
                    endcase
                end
                ...
                ST_ACK_DEV_ADD_R : begin
                    case(phase)
                        ...
                        2'b11 : begin
                            scl_drive_low           <= 1'b1;
                            bit_cnt                 <= 3'd7;
                            if(phase_tick) state    <= ST_READ_DATA;
                        end
                    endcase
                end
